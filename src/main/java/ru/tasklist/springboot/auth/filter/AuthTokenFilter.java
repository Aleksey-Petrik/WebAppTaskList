package ru.tasklist.springboot.auth.filter;
...
import ru.tasklist.springboot.auth.exception.JwtCommonException;
...
public class AuthTokenFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
        ...
        if (!isRequestToPublicAPI && // если пользователь (с помощью браузера!) обратился к защищенному URI, для которого нужна аутентификация
